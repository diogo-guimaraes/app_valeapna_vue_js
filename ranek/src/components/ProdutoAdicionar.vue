<template>
<!-- 
    refactor(component): ProdutoAdicionar
    add(component): ProdutoAdicionar
    rm(component): ProdutoAdicionar
  -->
...
<!-- 
    ...
    <input id="url" name="url" type="url" v-model="produto.url">
    ...
    <input class="btn" type="button" value="Adicionar" @click.prevent="adicionarProduto">
...
export default {
  ...
  methods: {
    ...
    formatarProduto() {
      ...
      form.append("url", this.produto.url);
